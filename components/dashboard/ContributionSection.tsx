      ...
      <div className="space-y-6 px-2 pt-4">
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-2">
            ...
            <span className="font-medium">
              Completed {contributions.activities.total} learning activities in{' '}
              {contributions.activities.categories.length} categories
            </span>
          ...
          <div className="ml-6 space-y-2">
            {contributions.activities.categories.map((category) => (
              <div key={category.name} className="flex items-center gap-3">
                <span className="min-w-0 flex-shrink-0 font-medium text-blue-500">
                  {category.name}
                </span>
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-2">
            ...
            <span className="font-medium">
              Submitted {contributions.submissions.total} tasks in{' '}
              {contributions.submissions.questName} quest
            </span>
            <div className="ml-auto">
              <svg
                className="text-muted-foreground h-4 w-4"
          ...
          <div className="ml-6 space-y-2">
            <div className="text-muted-foreground mb-3 text-sm">
              <span className="font-medium">
                {contributions.submissions.questName}
              </span>
              <span className="ml-4 inline-flex items-center gap-1 rounded bg-green-100 px-1.5 py-0.5 text-xs text-green-800 dark:bg-green-900 dark:text-green-200">
