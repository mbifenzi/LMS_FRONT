import { Clock, Calendar, Trophy, Star, BookOpen, Code, Database, Globe, type LucideIcon } from "lucide-react";
...
export interface Course {
  ...
  points: number;
  status: "available" | "inProgress" | "notStarted" | "paused" | "abandoned" | "completed";
  category: string;
  instructor: string;
  coverImage?: string;
  tags: string[];
...
export const mockCourses: Course[] = [
  // Not Started courses
  {
    ...
    description: "Learn the fundamentals of web development including HTML, CSS, and basic JavaScript concepts.",
    difficulty: "Beginner",
    duration: "40",
    points: 2500,
    status: "notStarted",
  ...
  },
  {
    ...
    description: "Learn database design principles, SQL queries, and database management concepts.",
  ...
  // Paused courses
  {
    ...
    description: "Introduction to machine learning algorithms and implementation with Python libraries.",
    difficulty: "Advanced",
    duration: "80",
    points: 6000,
    status: "paused",
  ...
  },
  {
    ...
    description: "Learn AWS cloud services, deployment, and cloud architecture best practices.",
    difficulty: "Intermediate",
    duration: "50",
    points: 4800,
    status: "paused",
  ...
  // Completed courses
  {
    ...
    description: "Master Git version control, branching strategies, and collaborative development.",
    difficulty: "Beginner",
    duration: "20",
    points: 2000,
    status: "completed",
  ...
  // Available courses
  {
    ...
    description: "Learn Vue.js from basics to advanced concepts including Vuex and Vue Router.",
    difficulty: "Intermediate",
    duration: "50",
    points: 4200,
    status: "available",
  ...
  },
  {
    ...
    description: "Master TypeScript for better JavaScript development with type safety and modern features.",
    difficulty: "Intermediate",
    duration: "40",
    points: 3800,
    status: "available",
  ...
  },
  {
    ...
    description: "Build efficient APIs with GraphQL, including queries, mutations, and subscriptions.",
    difficulty: "Advanced",
    duration: "45",
    points: 5000,
    status: "available",
  ...
  },
  {
    ...
    description: "Learn essential cybersecurity concepts, threat assessment, and security best practices.",
    difficulty: "Intermediate",
    duration: "60",
    points: 4500,
    status: "available",
